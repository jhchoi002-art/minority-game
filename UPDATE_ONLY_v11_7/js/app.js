...
/* Minority Game Ultimate v11.7 - static web app, no build step */
...
function renderTeacher(){
  ...
  App.el.innerHTML = `<main class="dash">
    <header class="dashHeader">
      <div><h1>소수결 게임 <span>Ultimate v11.7</span></h1><p>방코드 <b class="code">${App.room}</b> · ${esc(App.state.title||"")}</p></div>
...
function scheduleNameSave(){
  ...
  studentNameSaveTimer = setTimeout(()=>{ touchParticipant().catch(()=>{}); }, 350);
}
...
/* Student */
function student(){ startStudentHeartbeat(); listen(renderStudent); }
  ...
  App.el.innerHTML=`<main class="student"><section class="studentCard">
    ...
    <div class="studentInfo">
      ...
      <input id="sName" value="${esc(name)}" 
        oninput="localStorage.setItem('mg9_name', this.value);scheduleNameSave()"
        onblur="touchParticipant()">
