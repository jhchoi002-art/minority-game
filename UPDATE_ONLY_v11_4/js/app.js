var APP_VERSION = "11.4.0";

/* Minority Game Ultimate v11.4 - static web app, no build step */
...
async function createRoom(){
  ...
  const initialRoom = {
    ...
    appVersion: (typeof APP_VERSION !== "undefined" ? APP_VERSION : "11.4.0"),
    createdAt: now(),
...
function renderTeacher(){
  ...
  App.el.innerHTML = `<main class="dash">
    <header class="dashHeader">
      <div><h1>소수결 게임 <span>Ultimate v11.4</span></h1><p>방코드 <b class="code">${App.room}</b> · ${esc(App.state.title||"")}</p></div>
