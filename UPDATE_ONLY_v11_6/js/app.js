var APP_VERSION = "11.6.0";

/* Minority Game Ultimate v11.6 - static web app, no build step */
...
function renderTeacher(){
  ...
  App.el.innerHTML = `<main class="dash">
    <header class="dashHeader">
      <div><h1>소수결 게임 <span>Ultimate v11.6</span></h1><p>방코드 <b class="code">${App.room}</b> · ${esc(App.state.title||"")}</p></div>
    ...
    <section class="card">
      ...
      ${(typeof participantStatusHtml==='function'?participantStatusHtml():'<p class="hint">학생 접속 현황 기능을 불러오지 못했습니다.</p>')}
    </section>
